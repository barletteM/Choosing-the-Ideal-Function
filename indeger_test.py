...
@author: CORE i7
"""
from ChoosingIdeal_Fnc import createfr,SelectBestFit,FitModel
import unittest
import pandas as pd
...
Hint Before running the programme create a new database and save the module without running it to avoid overwritting of data
